...
/**
 * OrmLiteDatabaseConfigClass is a separate program from the actual android app,
 ...
 */
public class OrmLiteDatabaseConfigClass extends OrmLiteConfigUtil {

    /**
     * classes represents the models to use for generating the ormlite_config.txt file
     */
    private static final Class<?>[] classes = new Class[]{DatabaseModel.class};
